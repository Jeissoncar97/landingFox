      ...
      <div className="max-w-5xl mx-auto">
        <div className='bg-primary flex flex-col md:flex-row' >
          ...
          <div className='content-center text-white content-center w-full px-3 mb-10 md:mb-0'>
            ...
            <div className="text-center mt-6">
              <a className="px-8 py-2 text-xl bg-white text-primary mb-5" href="#">PEDIR</a>
            </div>
          </div>
        </div>
        ...
        <div className='bg-primary flex flex-col md:flex-row mt-5' >
          ...
          <div className='content-center text-white content-center w-full px-3 mb-10 md:mb-0'>
            ...
            <div className="text-center mt-6">
              <a className="px-8 py-2 text-xl bg-white text-primary mb-5" href="#">SABORES</a>
            </div>
          </div>
        </div>
        <div className='bg-primary flex flex-col md:flex-row mt-5' >
          ...
          <div className='content-center text-white content-center w-full px-3 mb-10 md:mb-0'>
            ...
            <p className='text-2xl'>Escoge tus sabores favoritos</p>
            <div className="text-center mt-6">
              <a className="px-8 py-2 text-xl bg-white text-primary" href="#">ORDENA AQUÍ</a>
            </div>
          </div>
        </div>
        <div className='bg-primary flex flex-col md:flex-row mt-5' >
          ...
          <div className='content-center text-white content-center w-full px-3 mb-10 md:mb-0'>
            ...
            <div className="text-center mt-6">
              <a className="px-8 py-2 text-xl bg-white text-primary" href="#">PIDELA AQUÍ</a>
            </div>
          </div>
        </div>
