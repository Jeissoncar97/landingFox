    ...
    <div className='max-w-5xl mx-auto py-10 px-4 font-permanentMarker text-center bg-primary-claro rounded-lg my-20'>
      ...
      <div className='flex justify-between mt-4 max-w-3xl mx-auto px-4 text-centerfont-bold'>
        ...
        <div className='flex grid grid-cols-3'>
          <h4 className="w-20 text-sm sm:text-lg mx-2">Personal</h4>
          <h4 className="w-20 text-sm sm:text-lg mx-2">Mediana</h4>
      ...
      <div className="gap-4 max-w-3xl mx-auto font-system">
        {platos.map((plato) => (
          <div key={plato.id} className=" p-4 rounded flex justify-between">
            ...
            <div className="mt-2 flex font-bold grid grid-cols-3 text-center">
              {plato.precio_per && (
                <p className="text-sm w-20 mx-2">${(plato.precio_per)}</p>
              )}
              {plato.precio_med && (
                <p className="text-sm w-20 mx-2">${(plato.precio_med)}</p>
              )}
              {plato.precio_gran && (
